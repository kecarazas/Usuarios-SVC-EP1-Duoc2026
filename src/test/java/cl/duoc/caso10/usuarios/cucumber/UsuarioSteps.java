package cl.duoc.caso10.usuarios.cucumber;
...
public class UsuarioSteps {
    ...
    private Long id;
    private ResponseEntity<Usuario> respuesta;
    ...
    public void servicioDisponible(String servicio) {
        ResponseEntity<Usuario[]> listado = rest.getForEntity(url(), Usuario[].class);
    ...
    public void crearRecurso(String recurso, String nombre) {
        ResponseEntity<Usuario> creado = rest.postForEntity(
                url(), body(nombre), Usuario.class);
    ...
    public void consultarCreado(String recurso) {
        respuesta = rest.getForEntity(url() + "/" + id, Usuario.class);
    }
    ...
    public void actualizar(String recurso, String nombre) {
        respuesta = rest.exchange(url() + "/" + id, HttpMethod.PUT, body(nombre), Usuario.class);
    }
    ...
    public void consultarEliminado(String recurso, int codigo) {
        ResponseEntity<Usuario> noExiste = rest.getForEntity(url() + "/" + id, Usuario.class);
